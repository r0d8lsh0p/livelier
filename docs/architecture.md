...
| **Event relay** (SW2) | Durable discovery events: every `30311` and the bridge operator's `kind:0` | Write whitelist = the bridge identity pubkey ONLY; reads open to everyone |
